...
namespace BroadwayShows.API.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(BroadwayShowsContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Genres != null ? 
                          ...
                          Problem("Entity set 'BroadwayShowsContext.Genres'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BroadwayShowsContext.Genres'  is null.");
            }
            var genre = await _context.Genres.FindAsync(id);
            if (genre != null)
            {
